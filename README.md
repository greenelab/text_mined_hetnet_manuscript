...
[![HTML Manuscript](https://img.shields.io/badge/manuscript-HTML-blue.svg)](https://greenelab.github.io/text_mined_hetnet_manuscript/)
...
[![Build Status](https://travis-ci.com/greenelab/text_mined_hetnet_manuscript.svg?branch=master)](https://travis-ci.com/greenelab/text_mined_hetnet_manuscript)
...
When a commit to the `master` branch occurs (for example, when a pull request is merged), Travis CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/greenelab/text_mined_hetnet_manuscript/tree/gh-pages) and [`output`](https://github.com/greenelab/text_mined_hetnet_manuscript/tree/output) branches.
...
Please attribute by linking to https://github.com/greenelab/text_mined_hetnet_manuscript.
...
Please open [an issue](https://github.com/greenelab/text_mined_hetnet_manuscript/issues) for any question related to licensing.

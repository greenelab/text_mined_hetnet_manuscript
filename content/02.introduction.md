...
<div style="color:red">
Why did are we using label functions/distant supervision?
</div>
...
As biomedical text comes in various forms (e.g. publications, clinician notes, image captions, etc.), we chose to subset this space to only include open-access publications.

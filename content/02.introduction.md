...
We don't consider environmental toxicants in our work, as our source databases for distant supervision, as well as our primary use cases, are primarily centered around FDA-approved therapies.
...
Even approaches as simple as calculating Z-scores from PubMed abstract co-occurrences can be informative [@tag:string], and there are numerous studies using co-occurrences [@tag:ppinterfinder; @tag:hpiminer; @protein_protein_co_network; @tag:full_text_co_abstracts].

...
We reported results in terms of AUROC (Figure {@fig:auroc_gen_model_test_set} and Supplemental Figure {@fig:auroc_grabbag_gen_model_test_set}) and AUPR (Supplemental Figures {@fig:aupr_gen_model_test_set} and {@fig:aupr_grabbag_gen_model_test_set}).

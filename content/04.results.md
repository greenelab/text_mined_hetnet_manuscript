...
The discriminative model's performance was often poorest when very few edge-specific label functions were incorporated into the baseline model (seen in DaG, Compound-binds-Gene (CbG), and Gene-interacts-Gene (GiG)). 

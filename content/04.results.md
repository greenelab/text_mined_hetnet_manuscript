...
Each line plot header depicts the edge type the discriminator model is trying to predict.
...
The baseline and “All” data points consisted of sampling from an entire fixed set of label functions, which makes the error bars flat.

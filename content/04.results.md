...
![
Text-mined edges can recall a fair amount of existing edges as well as add a myriad amount of novel edges to Hetionet v1 
...
These databases are often populated via some form of manual curation, which can result in missing information.
One of the goals in our work is to close this gap by populating Hetionet v1 with relationships found within biomedical literature.
We measured the extent to which this framework can recall preexisting edges as well as add novel edges to Hetionet v1.

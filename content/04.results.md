...
However, there's some evidence that label function transferability is possible for selected edge types and label function sources. 
Performance increases as more CbG label functions are incorporated into the GiG baseline model and vice versa.
...
](https://raw.githubusercontent.com/danich1/snorkeling-full-text/195fc92796cc20f48a57fd57ef25c16eefc25bc6/figure_generation/output/figure_two.png){#fig:auroc_gen_model_test_set}
...
Each point on the plot shows the average of 50 sample runs, while the error bars show the 95% confidence intervals of all runs.
The baseline and “All” data points consist of sampling from the entire fixed set of label functions.
](https://raw.githubusercontent.com/danich1/snorkeling-full-text/195fc92796cc20f48a57fd57ef25c16eefc25bc6/figure_generation/output/figure_four.png){#fig:auroc_grabbag_gen_model_test_set}

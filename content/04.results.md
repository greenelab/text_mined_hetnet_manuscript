...
Our discriminative model is a transformer called BioBERT [@arxiv:1901.08746] (See Methods and Materials for information on how we trained this model).
...
An exception to this trend is Compound treats Disease (CtD), where the discriminative model outperforms the generative model at all sampling levels.
...
This notion highlights that Hetionet v1 is missing a compelling amount of biomedical information, and this framework is a viable way to close the information gap.

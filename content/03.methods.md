...
The challenge of having too few ground truth annotations is familiar to many biomedical applications that use natural language processing techniques, even when unannotated text is abundant.

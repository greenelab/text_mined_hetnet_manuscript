...
We used a separate label function to prevent a label imbalance problem, which occurred when candidates that rarely appeared in databases were drowned out by negative labels.

...
Majority of our label functions fall into the text pattern category, while the others were distributed across the databases and domain heuristics (Table {@tbl:label-functions}).
We describe each category and provide an example label function below.

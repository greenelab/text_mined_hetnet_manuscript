...
The discriminative model is the ending step in this framework.
...
Typically, the discriminative model consists of some form of a neural network architecture to accomplish the above task.

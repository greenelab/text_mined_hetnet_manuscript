...
Edges in Hetionet v1 were obtained from open databases, such as the GWAS Catalog [@doi:10.1093/nar/gkw1133], Human Interactome Network [@doi:10.1016/j.cell.2014.10.050] and DrugBank [@doi:10.1093/nar/gkx1037].
...
PubTator Central provides MEDLINE abstracts that have been annotated with well-established entity recognition tools including Tagger One [@doi:10.1093/bioinformatics/btw343] for disease, chemical and cell line mentions, tmVar [@doi:10.1093/bioinformatics/btx541] for variant tagging, GNormPlus [@doi:10.1155/2015/918710] for gene mentions and SR4GN [@doi:10.1371/journal.pone.0038460] for species mentions. [@doi:10.1093/bioinformatics/btt474] for disease mentions.
...
Each candidate sentence was stratified by their corresponding document id to produce a training set, tuning set and a testing set (shown in Supplemental Table {@tbl:candidate-sentences}).
<div style="color:red">
TODO: Explain the document stratification process
explain that this strategy prevents data spillage (prediction for machine learning models becoming "too easy") from occurring
</div>
<div style="color:red">
TODO: Update the table with the correct number of train, tune, test
</div>
Despite the power of data programming, all text mining systems need to have ground truth labels to be well calibrated.
We hand labeled five hundred to a thousand candidate sentences of each edge type to obtain a ground truth set (Supplemental Table {@tbl:candidate-sentences}).

...
We evaluated both generative and discriminative models at each point, and reported performance of each in terms of the area under the receiver operating characteristic curve (AUROC) and the area under the precision-recall curve (AUPR).
